...
Deepens `src/10_full_brain_simulation` (currently a stub banner) into a real,
...
# Make `src.shared` importable when run as `python src/64_mini_dailybot_brain/mini_dailybot_brain.py`.
